...
export default function CreateOrdenUser({  getFirstName, getLastName, getAddres, getDay }: MyComponentClientProps) {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
                ...
                <Card shadow="md" className="w-full" >
                  ...
                  <CardHeader className=" gap-4  ">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-primary">{getFirstName + getLastName}</h2>
                  ...
                  <CardBody>
                    <p className="text-default-500">
                      Recorrido - <span className="font-semibold text-primary">{getAddres}</span>
                    </p>
                  </CardBody>
                </Card>
